...
CREATE TABLE `extintores` (
  `idExtintores` varchar(15) NOT NULL,
  `Area` varchar(30) DEFAULT NULL,
  `Planta` varchar(30) DEFAULT NULL,
  `Numero_extintor` varchar(10) DEFAULT NULL,
  `ubicacion_extintor` varchar(30) DEFAULT NULL,
  `Tipo` varchar(10) DEFAULT NULL,
  `capacidad_kg` decimal(3,0) DEFAULT NULL,
  `fecha_recarga` date DEFAULT NULL,
  `fecha_vencimiento` date DEFAULT NULL,
  `fecha_ult_prba_hidro` date DEFAULT NULL,
  PRIMARY KEY (`idExtintores`)
